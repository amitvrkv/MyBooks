...
public class RecyclerAdapterProductView extends RecyclerView.Adapter<RecyclerAdapterProductView.MyHolder> {
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(in.shopy.R.layout.books_list_view, parent, false);
    ...
    public void onBindViewHolder(final MyHolder holder, final int position) {
        ...
        holder.wishListBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Animation zoomin = AnimationUtils.loadAnimation(ctx, in.shopy.R.anim.zoom_in);
                final Animation zoomout = AnimationUtils.loadAnimation(ctx, in.shopy.R.anim.zoom_out);
    ...
    public void checkCartandWishlist(final MyHolder holder, Context ctx, final String key) {
        final SQLiteDatabase sqLiteDatabase = SQLiteDatabase.openOrCreateDatabase(ctx.getString(in.shopy.R.string.database_path), null);

        final SQLiteDatabase sqLiteDatabaseWishlist = SQLiteDatabase.openOrCreateDatabase(ctx.getString(in.shopy.R.string.database_path), null);
    ...
    private void makeFlyAnimation(final View targetView) {
        ...
        new CircleAnimationUtil().attachActivity(act).setTargetView(targetView).setMoveDuration(500).setDestView(destView).setAnimationListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                Animation animation1 = AnimationUtils.loadAnimation(ctx, in.shopy.R.anim.fade_in);
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(View mview) {
            ...
            wishListBtn = (ImageView) mview.findViewById(in.shopy.R.id.wishListBtn);
            wishListBtnAdded = (ImageView) mview.findViewById(in.shopy.R.id.wishListBtnAdded);

            loadimage_progress_bar = (ProgressBar) mview.findViewById(in.shopy.R.id.loadimage_progress_bar);

            mtitle = (TextView) mview.findViewById(in.shopy.R.id.p_f2);
            mtitle.setText("");
            mpublisher = (TextView) mview.findViewById(in.shopy.R.id.p_f3);
            mpublisher.setText("");
            mBookImage = (ImageView) mview.findViewById(in.shopy.R.id.p_f13);
            mauthor = (TextView) mview.findViewById(in.shopy.R.id.p_f4);
            mauthor.setText("");
            mcourse = (TextView) mview.findViewById(in.shopy.R.id.p_f5);
            mcourse.setText("");
            msem = (TextView) mview.findViewById(in.shopy.R.id.p_f6);
            msem.setText("");
            mrp_price = (TextView) mview.findViewById(in.shopy.R.id.p_f7);
            mrp_price.setText("");
            mrp_price.setPaintFlags(mrp_price.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
            old_price = (TextView) mview.findViewById(in.shopy.R.id.p_f9);
            old_price.setText("");
            new_price = (TextView) mview.findViewById(in.shopy.R.id.p_f8);
            new_price.setText("");

            //new_price.setPaintFlags(new_price.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);

            outofstockimg = (ImageView) mview.findViewById(in.shopy.R.id.outofstock);

            addToCartButton = (TextView) mview.findViewById(in.shopy.R.id.addToCartButton);
            addToCartButton.setVisibility(View.GONE);


            linearLayout = (LinearLayout) mview.findViewById(in.shopy.R.id.card_parent);
