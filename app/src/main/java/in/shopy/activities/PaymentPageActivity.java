...
public class PaymentPageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(in.shopy.R.layout.activity_payment_page);

        setToolbar();

        mDeliveryAddress = (TextView) findViewById(in.shopy.R.id.deliveryAddress);
        mUpdateAddressBtn = (TextView) findViewById(in.shopy.R.id.updateAddress);
        mUpdateAddressBtn.setOnClickListener(this);
        mPlaceOrder = (Button) findViewById(in.shopy.R.id.placeOrderBtn);
        mPlaceOrder.setOnClickListener(this);
        mModeCOD = (RadioButton) findViewById(in.shopy.R.id.modeCOD);
        ...
        parentLayoutView = findViewById(in.shopy.R.id.paymentActicityParentView);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case in.shopy.R.id.payment_applyPromocode:
                applyPromocode();
                break;
        }
    }
    ...
    private boolean setCharges() {
        TextView payment_total = (TextView) findViewById(in.shopy.R.id.payment_total);
        ...
        final TextView payable_amount = (TextView) findViewById(in.shopy.R.id.payable_amount);
        ...
        if (discount == 0) {
            ...
            payment_applyPromocode.setTextColor(getResources().getColor(in.shopy.R.color.colorAccent));
        } else {
            payment_applyPromocode.setText(promocode + " applied. Try new?");
            payment_applyPromocode.setTextColor(getResources().getColor(in.shopy.R.color.Green));
        }
    ...
    private void setWallet() {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                final CheckBox checkBoxWallet = (CheckBox) findViewById(in.shopy.R.id.walletAmt);
