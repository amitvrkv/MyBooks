...
import in.shopy.models.OrderCustomDetailsBookList;
...
public class OrderCustomDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(in.shopy.R.layout.activity_order_custom_details);

        Bundle bundle = getIntent().getExtras();
        orderId = bundle.getString("orderId");

        recyclerView = (RecyclerView) findViewById(in.shopy.R.id.orderDetailsRecycleView);
    ...
    private void setBillDetailsAndShippingAddress() {
        final TextView textViewAddress = (TextView) findViewById(in.shopy.R.id.address);
        final TextView payment_total = (TextView) findViewById(in.shopy.R.id.payment_total);
        final TextView payment_delivery_charge = (TextView) findViewById(in.shopy.R.id.payment_delivery_charge);
        final TextView payment_discount = (TextView) findViewById(in.shopy.R.id.payment_discount);
        final TextView wallet_amount = (TextView) findViewById(in.shopy.R.id.wallet_amount);
        final TextView payment_payable_amt = (TextView) findViewById(in.shopy.R.id.payment_payable_amt);
        final TextView payment_mode = (TextView) findViewById(in.shopy.R.id.payment_mode);
    ...
    private void setProductCounts() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                TextView product_count = (TextView) findViewById(in.shopy.R.id.product_count);
    ...
    public void setProductDetails() {
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<OrderCustomDetailsBookList, OrderCustomDetailsViewHolder>(
                ...
                in.shopy.R.layout.order_book_list_view,
    ...
    public static class OrderCustomDetailsViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setFields(String author, String bookType, String course, String description, String estPrice, String key, String mrp, String publisher, String qty, String title, String total) {
            ...
            TextView mTitle = (TextView) view.findViewById(in.shopy.R.id.obookTitle);
            TextView mPublisher = (TextView) view.findViewById(in.shopy.R.id.obookPublisher);
            TextView mAuthor = (TextView) view.findViewById(in.shopy.R.id.obookAuthor);
            TextView mType = (TextView) view.findViewById(in.shopy.R.id.obooktype);
            TextView mPricePerBook = (TextView) view.findViewById(in.shopy.R.id.obookPricePerBook);
            TextView mQty = (TextView) view.findViewById(in.shopy.R.id.oQuantity);
            TextView mbook_grand = (TextView) view.findViewById(in.shopy.R.id.obookGrandTotal);
            ImageView mBookImage = (ImageView) view.findViewById(in.shopy.R.id.obookImage);
        ...
        public void setFieldsFromKey(String key, final String type, final String qty) {
            this.key = key;
            final TextView mTitle = (TextView) view.findViewById(in.shopy.R.id.obookTitle);
            TextView mPublisher = (TextView) view.findViewById(in.shopy.R.id.obookPublisher);
            mPublisher.setVisibility(View.GONE);
            TextView mAuthor = (TextView) view.findViewById(in.shopy.R.id.obookAuthor);
            mAuthor.setVisibility(View.GONE);
            final TextView mType = (TextView) view.findViewById(in.shopy.R.id.obooktype);
            final TextView mPricePerBook = (TextView) view.findViewById(in.shopy.R.id.obookPricePerBook);
            final TextView mQty = (TextView) view.findViewById(in.shopy.R.id.oQuantity);
            final TextView mbook_grand = (TextView) view.findViewById(in.shopy.R.id.obookGrandTotal);
            final ImageView mBookImage = (ImageView) view.findViewById(in.shopy.R.id.obookImage);
